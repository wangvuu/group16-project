namespace duanso1.Model
{
    ...
    // ── HỒ SƠ KHÁM ───────────────────────────────────────────────
    // ✅ FIX: Dùng DateOnly thay DateTime vì PostgreSQL lưu kiểu DATE (không có giờ)
    ...
    // ✅ FIX: Thay thế dynamic trong HoSoKhamController.Create
    ...
    // ✅ FIX: Thay thế dynamic trong HoSoKhamController.UpdateTrangThai
